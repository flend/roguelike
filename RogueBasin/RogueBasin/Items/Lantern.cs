...
{
    public class Lantern : Item, IEquippableItem
    {
        /// <summary>
        ...
        {
            LogFile.Log.LogEntryDebug("Wielding Lantern", LogDebugLevel.Medium);
            ...
            //Messages
            Game.MessageQueue.AddMessage("The light of the lantern shines out into the wilderness.");
