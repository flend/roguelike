...
namespace RogueBasin.Items
{
    public class BioWare : Item, IEquippableItem
    {
        ...
        {
            LogFile.Log.LogEntryDebug("BioWare equipped", LogDebugLevel.Medium);

            Player player = user as Player;
            player.AddEffect(new PlayerEffects.BioProtect());
        ...
        {
            LogFile.Log.LogEntryDebug("BioWare unequipped", LogDebugLevel.Low);

            Player player = user as Player;
            player.RemoveEffect(typeof(PlayerEffects.BioProtect));
