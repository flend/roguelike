...
namespace RogueBasin.Items
{
    public class FragGrenade : Item, IEquippableItem
    {
        ...
        public Point ThrowItem(Point target)
        {
            ...
            Point dest = Game.Dungeon.Combat.ThrowItemGrenadeLike(this, Game.Dungeon.Player.LocationLevel, target, Game.Dungeon.Player.ScaleRangedDamage(this, DamageBase()));
