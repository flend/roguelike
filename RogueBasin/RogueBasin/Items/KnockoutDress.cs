...
{
    public class KnockoutDress : Item, IEquippableItem
    {
        /// <summary>
        ...
        {
            LogFile.Log.LogEntryDebug("Wearing a Knockout Dress", LogDebugLevel.Medium);
            ...
            //Messages
            Game.MessageQueue.AddMessage("Wearing a Knockout Dress! Suave, sexy and revealing, just the thing for a Princess on her adventures!");
