...
{
    public class Backpack : Item, IEquippableItem
    {
        /// <summary>
        ...
        {
            LogFile.Log.LogEntryDebug("Backpack equipped", LogDebugLevel.Medium);
            ...
            {
                Screen.Instance.PlayMovie("plotbackpack", true);
            }
        ...
        {
            LogFile.Log.LogEntryDebug("Backpack unequipped", LogDebugLevel.Low);
            return true;
        }
        /// <summary>
        /// not used in this game
