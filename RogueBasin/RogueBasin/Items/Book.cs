...
{
    public class Book : Item, IEquippableItem
    {
        /// <summary>
        ...
        {
            LogFile.Log.LogEntryDebug("Book unequipped", LogDebugLevel.Low);
            return true;
        }
        /// <summary>
        /// not used in this game
