...
{
    public class Stone : Item, IEquippableItem
    {
        /// <summary>
        ...
        {
            LogFile.Log.LogEntryDebug("Stone equipped", LogDebugLevel.Medium);
            ...
            {
                Screen.Instance.PlayMovie("plotstone", true);
            }
        ...
        {
            LogFile.Log.LogEntryDebug("Stone unequipped", LogDebugLevel.Low);
            return true;
        }
        /// <summary>
        /// not used in this game
