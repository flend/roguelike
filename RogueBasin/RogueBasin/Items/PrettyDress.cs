...
{
    public class PrettyDress : Item, IEquippableItem
    {
        /// <summary>
        ...
        public bool Equip(Creature user)
        {
            ...
            //Messages
            Game.MessageQueue.AddMessage("Wearing a Pretty Dress! It's blue.");
        ...
        {
            return ColorPresets.BlueViolet;
        }
