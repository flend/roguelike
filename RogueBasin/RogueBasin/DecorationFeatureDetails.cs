...
namespace RogueBasin
{
    public static class DecorationFeatureDetails
    {
        ...
        {
            decorationFeatures.Add(DecorationFeatures.Bone, new Decoration((char)314, ColorPresets.Ivory, false));
            decorationFeatures.Add(DecorationFeatures.Skeleton, new Decoration((char)315, ColorPresets.Ivory, false));
            ...
            decorationFeatures.Add(DecorationFeatures.Stool, new Decoration((char)383, ColorPresets.RosyBrown, false));
            decorationFeatures.Add(DecorationFeatures.Chair1, new Decoration((char)397, ColorPresets.RosyBrown, false));
            decorationFeatures.Add(DecorationFeatures.Chair2, new Decoration((char)398, ColorPresets.RosyBrown, false));
            ...
            decorationFeatures.Add(DecorationFeatures.Plant1, new Decoration((char)429, ColorPresets.RosyBrown, false));
            decorationFeatures.Add(DecorationFeatures.Plant2, new Decoration((char)430, ColorPresets.RosyBrown, false));
            decorationFeatures.Add(DecorationFeatures.HighTechBench, new Decoration((char)431, ColorPresets.BlueViolet, true));
            decorationFeatures.Add(DecorationFeatures.Plant3, new Decoration((char)445, ColorPresets.RosyBrown, false));
            ...
            decorationFeatures.Add(DecorationFeatures.HumanCorpse, new Decoration((char)510, ColorPresets.Ivory, false));
            decorationFeatures.Add(DecorationFeatures.HumanCorpse2, new Decoration((char)511, ColorPresets.Ivory, false));
