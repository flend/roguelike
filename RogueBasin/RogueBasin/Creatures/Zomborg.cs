...
namespace RogueBasin.Creatures
{
    ...
    /// </summary>
    public class Zomborg : MonsterFightAndRunAI
    {

        public Zomborg(int level)
            : base(level)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public override string SingleDescription { get { return "Zomborg"; } }

        /// <summary>
        /// Rats
        /// </summary>
        public override string GroupDescription { get { return "Zomborgs"; } }
